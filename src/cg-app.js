...
Polymer({
  _template: html`
        ...
        <!-- load site data -->
        <iron-ajax auto="" url="../data.json" handle-as="json" last-response="{{data}}"></iron-ajax>
        ...
        <app-drawer-layout fullbleed="">
            ...
            <app-header-layout id="layout">
                ...
                <neon-animated-pages id="animPages" selected="[[page]]" attr-for-selected="name" fallback-selection="view404" entry-animation="slide-from-left-animation" exit-animation="slide-right-animation" role="main">
