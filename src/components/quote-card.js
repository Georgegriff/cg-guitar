...
$_documentContainer.innerHTML = `<dom-module id="quote-card" include="shared-styles">
    <template>
        <style>
            :host {
                display: block;
    ...
    <paper-card elevation="{{elevation}}" class="quote-card" animated-shadow="true">
    <div class="card-content">
        <div class="quote-image">
         ...
         <div class="quote-info">
            ...
            <div class="quote-name" inner-h-t-m-l="{{text}}"></div>
         </div>
